...
// create with verify
// forge script script/test/ShamanSingleProp.s.sol:ShamanSinglePropScript --rpc-url $RU --private-key $PK --broadcast --verify --etherscan-api-key $EK -vvvv

// create without verify
// forge script script/test/ShamanSingleProp.s.sol:ShamanSinglePropScript --rpc-url $RU --private-key $PK --broadcast -vvvv
...
contract ShamanSinglePropScript is Script {
