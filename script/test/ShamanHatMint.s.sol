...
// forge script script/test/ShamanHatMint.s.sol:ShamanHatMintScript --rpc-url $RU --broadcast --verify --etherscan-api-key $EK -vvvv
...
contract ShamanHatMintScript is TestHelperScript {
    function run() public {
        ...
        ROM.mintAdminHatProposal(0xD5d1bb95259Fe2c5a84da04D1Aa682C71A1B8C0E);
